...
void main()
{
    ...
    for(int studentCount = 0; studentCount < numberOfStudents; ++studentCount)
    {
        ...
        scanf("%s", studentsList[studentCount].name);

        printf("Enter Roll Number:\n");
        scanf("%d", &studentsList[studentCount].rollNo);

        printf("Enter department:\n");
        scanf("%s", studentsList[studentCount].department);

        printf("Enter fees:\n");
        scanf("%d", &studentsList[studentCount].fees);
    }
